...
class ClaudeCodeAdapter(ClientAdapter):
    """Adapter for Claude Code (stub — coming in v0.10.2)."""
    ...
    def config_paths(self) -> list[Path]:
        raise NotImplementedError(
            "Claude Code adapter coming in v0.10.2. "
...
class CursorAdapter(ClientAdapter):
    """Adapter for Cursor (stub — coming in v0.10.2)."""
    ...
    def config_paths(self) -> list[Path]:
        raise NotImplementedError(
            "Cursor adapter coming in v0.10.2. "
            "Use --client claude-desktop for now."
        )
...
class WindsurfAdapter(ClientAdapter):
    """Adapter for Windsurf (stub — coming in v0.10.2)."""
    ...
    def config_paths(self) -> list[Path]:
        raise NotImplementedError(
            "Windsurf adapter coming in v0.10.2. "
            "Use --client claude-desktop for now."
        )
