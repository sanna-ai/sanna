"""v0.12.3 integration smoke tests — Block 8 final validation.

These tests verify the complete v0.12.3 release works end-to-end:
...
class TestUnifiedCLISmoke:
    ...
    def test_version(self, capsys):
        with patch("sys.argv", ["sanna", "--version"]):
            rc = main_sanna()
        assert rc == 0
        assert "0.12.3" in capsys.readouterr().out
